...
title: ${file.name}
date: ${dateStr}
permalink: ${getPermalink()}${file.filePath.includes('_posts') ? `${os.EOL}sidebar: auto` : ''}${cateStr}${tagsStr}
${extendFrontmatterStr}---`
      ...
      if (file.filePath.includes('_posts') && !matterData.hasOwnProperty('sidebar')) { // auto侧边栏，_posts文件夹特有
