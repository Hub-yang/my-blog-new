...
export default {
  ...
  methods: {
    ...
    getCommentTop() {
      setTimeout(() => {
        const commentEl = document.querySelector(this.COMMENT_SELECTOR_1) || document.querySelector(this.COMMENT_SELECTOR_2) || document.querySelector(this.COMMENT_SELECTOR_3)
        if (commentEl) {
